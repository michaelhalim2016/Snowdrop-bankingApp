    ...
    return Scaffold(
      ...
      body: Padding(
        padding: EdgeInsets.only(
            right: Sizes.size16, left: Sizes.size16, top: Sizes.size20),
        child: Center(
            child: Column(
          children: [
            SizedBox(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            Padding(
                              padding: EdgeInsets.only(
                                  top: Sizes.size12, right: Sizes.size12),
                              child: Align(
                            ...
                            Padding(
                              padding: EdgeInsets.only(
                                  top: Sizes.size30, left: Sizes.size12),
                              child: const Align(
                            ...
                            Padding(
                              padding: EdgeInsets.only(
                                  top: Sizes.size14, left: Sizes.size12),
                              child: Align(
                                alignment: Alignment.centerLeft,
                                child: Image.asset(
                                  ImagePaths.chip,
                            ...
                            Padding(
                              padding: EdgeInsets.only(
                                  top: Sizes.size14, left: Sizes.size10),
                              child: Align(
                            ...
                            Padding(
                              padding: EdgeInsets.only(
                                  top: Sizes.size10, left: Sizes.size12),
                              child: Align(
                                alignment: Alignment.topLeft,
                                child: Text(
                                  // '\$ 1,000.00',
                    ...
                    child: Container(
                      decoration: _selectedBackground == '1'
                          ? BoxDecoration(
                              ...
                              border: Border.all(
                                  width: 3, color: AppColors.baseColor))
                          : null,
                      child: Image.asset(
            ...
            Padding(
                ...
                child: AppButton(
                  ...
                  isValid: true,
                  onTap: () async {
                    await AuthService().addCard(_selectedBackground, _target,
                        _pocketNameController.text, '0000 0000 0000 0000');
