...
class ImagePaths {
  // onboarding screen 1
  static String onboarding1_1 = 'assets/onboarding_image/credit_card_1.png';
  static String onboarding1_2 = 'assets/onboarding_image/credit_card_1_2.png';

  // onboarding screen 2
  static String onboarding2 = 'assets/onboarding_image/onboarding_2.png';

  // onboarding screen 3
  static String onboarding3 = 'assets/onboarding_image/onboarding_3.png';
  ...
  static String companyIcon = 'assets/company_icon1 (2).png';

  // home screen
  static String companyIconColor = 'assets/company_icon_color1.png';
  ...
  static String cardLogo = 'assets/card_logo11.png';
...
class Strings {
  ...
  static String onboarding1Description =
      'Transfer and receive your money easily with SnowDrop bank';
  static String swipe = 'Swipe for more';

  // onboarding screen 2
  static String onboarding2Title = 'Transfers between accounts';
  static String onboarding2Description =
      'Transferring balances is very easy between SnowDrop bank accounts';
  ...
  static String dFlyBankUsers = 'SnowDrop bank users';
